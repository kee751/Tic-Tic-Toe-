import logging
import asyncio
import os  # ဒီ line လေး အရေးကြီးပါတယ်
...
# Token ကို Environment Variable ကနေ ဖတ်ယူခြင်း (အလုံခြုံဆုံးနည်းလမ်း)
TOKEN = os.getenv("BOT_TOKEN")

if not TOKEN:
    raise ValueError("BOT_TOKEN ကို Render Environment Variable မှာ မတွေ့ရှိပါ။ ကျေးဇူးပြု၍ စစ်ဆေးပေးပါ။")
